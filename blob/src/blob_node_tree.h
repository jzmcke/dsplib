...
int
blob_node_tree_retrieve_start(blob_node_tree_retrieve **p_ntr, char *node_name);

int
blob_node_tree_retrieve_flush(blob_node_tree_retrieve **p_ntr);

int
blob_node_tree_retrieve_int_a(blob_node_tree_retrieve *p_ntr, const char *var_name, const unsigned int **pp_var_val, int *p_n, int rep);
int
blob_node_tree_retrieve_float_a(blob_node_tree_retrieve *p_ntr, const char *var_name, const unsigned int **pp_var_val, int *p_n, int rep);
int
...
int
blob_node_tree_int_a(blob_node_tree_send *p_nts, const char *var_name, float *p_var_val, int n);
int
blob_node_tree_unsigned_int_a(blob_node_tree_send *p_nts, const char *var_name, float *p_var_val, int n);